...
namespace CRM {
    ...
    public class rptTKKHHH : ReportClass {
    ...
    public class CachedrptTKKHHH : Component, ICachedReport {
        
        public CachedrptTKKHHH() {
        }
