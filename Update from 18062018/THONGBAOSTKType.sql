...
/****** Object:  UserDefinedTableType [dbo].[THONGBAOSTKType]    Script Date: 06/19/2018 17:26:37 ******/
IF  EXISTS (SELECT * FROM sys.types st JOIN sys.schemas ss ON st.schema_id = ss.schema_id WHERE st.name = N'THONGBAOSTKType' AND ss.name = N'dbo')
DROP TYPE [dbo].[THONGBAOSTKType]
GO
